...
export default function LibraryScreen() {
  ...
  return (
    <Screen style={{ padding: 0 }}>
      ...
      {error ? (
        <Card style={{ margin: tokens.space(4) }}>
...
const makeStyles = (c: Palette) =>
  StyleSheet.create({
    ...
    docTitle: { fontFamily: tokens.fonts.display, color: c.text, fontSize: 19, fontWeight: '600', letterSpacing: -0.3 },
    ...
    progressFill: { height: 5, backgroundColor: c.accent },
  });
